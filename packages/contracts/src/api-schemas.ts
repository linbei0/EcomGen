...
export const Job = Type.Object({ id: Type.String({ format: "uuid" }), type: Type.Union([Type.Literal("PLAN"), Type.Literal("COPYWRITE"), Type.Literal("GENERATE"), Type.Literal("EXPORT"), Type.Literal("EDIT_PLAN"), Type.Literal("EDIT_GENERATE"), Type.Literal("LAYER_PLAN"), Type.Literal("LAYER_EXPORT"), Type.Literal("SUITE_FORGE")]), status: Type.Union([Type.Literal("QUEUED"), Type.Literal("RUNNING"), Type.Literal("SUCCEEDED"), Type.Literal("FAILED"), Type.Literal("CANCELLED")]), progress: Type.Integer({ minimum: 0, maximum: 100 }), retryable: Type.Boolean(), requestFingerprint: Type.Optional(Type.Union([Type.String(), Type.Null()])), providerId: Type.Optional(Type.Union([Type.String({ format: "uuid" }), Type.Null()])), modelId: Type.Optional(Type.Union([Type.String(), Type.Null()])), estimatedCost: Type.Optional(Type.Union([Type.Record(Type.String(), Type.Unknown()), Type.Null()])), actualCost: Type.Optional(Type.Union([Type.Record(Type.String(), Type.Unknown()), Type.Null()])), cancelRequested: Type.Optional(Type.Boolean()), error: Type.Optional(Type.Union([Type.Record(Type.String(), Type.Unknown()), Type.Null()])), progressDetail: Type.Optional(Type.Union([schemaRef(JobProgressDetail), Type.Null()])), createdAt: Type.String({ format: "date-time" }), updatedAt: Type.Optional(Type.String({ format: "date-time" })) }, { $id: "#/components/schemas/Job" });
